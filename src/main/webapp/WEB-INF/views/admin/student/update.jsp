                ...
                <form id="updateForm" novalidate>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>系统识别：</label>
                            <input type="text" class="form-control" name="id" value="${requestScope.updateStudent.id}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label>学号：</label>
                            <input type="text" class="form-control" name="no" value="${requestScope.updateStudent.no}" required>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>姓名：</label>
                                <input type="text" class="form-control" name="realName" value="${requestScope.updateStudent.realName}" required>
                                <div class="invalid-feedback">姓名不能为空</div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>生日：</label>
                                <input type="text" class="form-control" name="birthDay"
                                       id="birthDay" value="${requestScope.updateStudent.birthDay}" required readonly>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="phone" autocomplete="off"
                                       value="${requestScope.updateStudent.phone}" required>
                                <div class="invalid-feedback">手机号不能为空</div>
                            </div>
                            <div class="form-group col-md-6">
                                <label>邮箱：</label>
                                <input type="email" class="form-control" name="email"
                                        value="${requestScope.updateStudent.email}" required >
                        ...
                        <div class="form-row">
                            ...
                            <div class="img-show">
                                <img class="img-fluid photo-size" src="${requestScope.updateStudent.addressPhotoPath}"/>
                            </div>
                        </div>
                        <div class="d-flex justify-content-around">
                            <input type="button" onclick="updateStudnet()" class="btn btn-primary" value="修改">
                            <<a href="#" class="btn btn-primary" onclick="history.go(-1)">返回</a>
                        </div>
